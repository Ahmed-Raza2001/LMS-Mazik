<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TeacherSubject.aspx.cs" Inherits="WebApplication1.Admin.TeacherSubject" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Class">
                                <EditItemTemplate>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LMS_MazikEntities %>" 
                            ...
                            <asp:TemplateField HeaderText="Teacher">
                                <EditItemTemplate>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LMS_MazikEntities %>" 
